...
export data_dir="/scratch/rml6079/project/GEN_CLS/FewNERD/data/${setting}/token_cls"  
...
export epoch=5
export lr_proj=3e-3
export out_dir="out/${setting}/token_cls/${model}"

python run_cls_token_level.py \
    ...
    --label_list_file /scratch/rml6079/project/GEN_CLS/FewNERD/data/labels.txt
