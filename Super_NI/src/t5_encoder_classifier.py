...
class SequenceClassifierOutput_Grouped(SequenceClassifierOutput):
    def __init__(self, loss=None, logits=None, hidden_states=None, attentions=None, id=None):
...
class T5EncoderForSequenceClassification(T5EncoderModel):
    ...
    def forward(
        ...
        id: a list of string to identify the sample
        candidates: a list of string, standing for the candidate output for each sample
        """
        ...
        return SequenceClassifierOutput(
            ...
            attentions=encoder_outputs.attentions), id, candidates