...
class NITrainingArguments(Seq2SeqTrainingArguments):
    ...
    hub_model_id: Optional[str] = field(
        default=None,
        metadata={"help": "The name of the model to upload to the hub after training."}
    )
...
def main():
    ...
    # push model to huggingface hub (huggingface_hub version '0.13.3')
    model.push_to_hub(training_args.hub_model_id, use_auth_token=True)
    tokenizer.push_to_hub(training_args.hub_model_id, use_auth_token=True)
