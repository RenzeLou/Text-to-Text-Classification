...
export out_dir="out/${shot}-shot/gen"
export data_dir="/scratch/rml6079/project/GEN_CLS/intent_identification/data/banking_data/${shot}-shot/gen"
...
export model="t5-3b"
export out_dir="out/${shot}-shot/gen/${model}"
...
# export out_dir="out/gen/lr_${lr}-epoch_${epoch}-model_${model}"
# python run_sen_gen.py \
#     --model_name_or_path ${model} \
#     --do_train \
#     --do_eval \
